  ...
  <div>
    <el-row class="wrapper">
      ...
      <el-col class="bottom-placeholder">
        {{ this.business.copyright }}
        <a target="_blank" :href="this.business.businessSite"> {{ this.business.businessName }} </a>
      </el-col>
    </el-row>
  </div>
</template>
...
export default {
  data() {
    return {
      business: kindo.config.business,
